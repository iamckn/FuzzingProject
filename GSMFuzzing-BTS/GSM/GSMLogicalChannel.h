...
class CCCHLogicalChannel : public NDCCHLogicalChannel {
	...
	*/
	...
	void send(const L3RRMessage& msg, Primitive wPrivmitive=UNIT_DATA)
		{ LOG(ERROR)<<L3Frame((const L3Message&)msg,wPrivmitive); COUT(L3Frame((const L3Message&)msg,wPrivmitive)); mQ.write(new L3Frame((const L3Message&)msg,wPrivmitive)); }
